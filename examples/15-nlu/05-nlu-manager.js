...
// const manager = new NluManager({ container, locales: ['en', 'es'], useNoneFeature: false, trainByDomain: true });
(async () => {
  ...
  //   },
  //   classifications: [
  //     { intent: 'agent.acquaintance', score: 0.8700343801471809 },
  //     { intent: 'agent.age', score: 0.12996561985281913 }
  //   ],
  //   intent: 'agent.acquaintance',
  //   score: 0.8700343801471809
  // }
})();
