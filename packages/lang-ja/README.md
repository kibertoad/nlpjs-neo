...
[![NPM version](https://img.shields.io/npm/v/@nlpjs-neo/lang-ja.svg?style=flat)](https://www.npmjs.com/package/@nlpjs-neo/lang-ja)
[![NPM downloads](https://img.shields.io/npm/dm/@nlpjs-neo/lang-ja.svg?style=flat)](https://www.npmjs.com/package/@nlpjs-neo/lang-ja)
...
`@nlpjs-neo/lang-ja` is the Japanese language plugin of NLP.js Neo. It bundles the tokenizer, the
stemmer, the stopwords, the normalizer and, where the language has one, the sentiment
dictionary, and registers them in the container for the `ja` locale.
...
| Export | What it is |
| ------ | ---------- |
| `LangJa` | the plugin that registers everything below in a container |
