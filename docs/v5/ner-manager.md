...
* [BuiltIn-Microsoft](./builtin-entity-extraction.md) - This builtin is executed on server side in Node.js, but does not support all languages
* [Facebook Duckling](./builtin-duckling.md) - This builtin forwards the call to a running instance of a Duckling server process.
