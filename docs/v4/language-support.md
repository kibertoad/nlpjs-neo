...
| da     | Danish                |        X       |                    |         X         |     X     |
| nl     | Dutch                 |        X       |                    |         X         |     X     |
| en     | [English](https://github.com/axa-group/nlp.js/blob/master/packages/lang-en/README.md)             |        X       |          X         |         X         |     X     |
| et     | Estonian              |                |                    |         X         |           |
| fi     | Finnish               |        X       |                    |         X         |     X     |
| fr     | French                |        X       |          X         |         X         |     X     |
| gl     | Galician              |        X       |                    |                   |     X     |
...
| is     | Icelandic             |                |                    |         X         |           |
| io     | Ido                   |                |                    |                   |           |
| id     | [Indonesian](https://github.com/axa-group/nlp.js/blob/master/packages/lang-id/README.md)          |        X       |                    |         X         |     X     |
| ga     | Irish                 |        X       |                    |         X         |     X     |
| it     | [Italian](https://github.com/axa-group/nlp.js/blob/master/packages/lang-it/README.md)             |        X       |                    |         X         |     X     |
| ja     | Japanese              |        X       |          X         |         X         |           |
| jv     | Javanese              |                |                    |                   |           |
| kn     | Kannada               |                |                    |         X         |           |
| kk     | Kazakh                |                |                    |                   |           |
...
| es     | [Spanish](https://github.com/axa-group/nlp.js/blob/master/packages/lang-es/README.md)             |        X       |          X         |         X         |     X     |
| su     | Sundanese             |                |                    |                   |           |
| sw     | Swahili               |                |                    |         X         |           |
| sv     | Swedish               |        X       |                    |         X         |     X     |
| tl     | Tagalog               |        X       |                    |                   |     X     |
