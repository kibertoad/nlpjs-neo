...
'@nlpjs-neo/lang-th': patch
'@nlpjs-neo/lang-tl': patch
'@nlpjs-neo/lang-tr': patch
'@nlpjs-neo/lang-uk': patch
'@nlpjs-neo/lang-zh': patch
'@nlpjs-neo/language': patch
'@nlpjs-neo/language-min': patch
'@nlpjs-neo/logger': patch
'@nlpjs-neo/ner': patch
'@nlpjs-neo/neural': patch
'@nlpjs-neo/nlg': patch
'@nlpjs-neo/nlp': patch
'@nlpjs-neo/nlu': patch
'@nlpjs-neo/request': patch
'@nlpjs-neo/sentiment': patch
'@nlpjs-neo/similarity': patch
'@nlpjs-neo/slot': patch
'@nlpjs-neo/xtables': patch
'node-nlp-neo': patch
---

Complete the publishing metadata of every package: a `prepublishOnly` hook that compiles
